...
export default function Modal({ product, toggleModal }: IModalProp) {
    ...
    return (
        ...
        <div className="fixed top-[5%] flex flex-col items-start z-[100] w-[90%] h-full max-h-[90vh] bg-white border rounded-md p-0 shadow-lg">
            <button
